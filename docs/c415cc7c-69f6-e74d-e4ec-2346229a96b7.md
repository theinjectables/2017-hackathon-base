# AzureEndpointItemModel.ServiceManagerConfigurationPath Field
 _**\[This is preliminary documentation and is subject to change.\]**_

Constant value containing the name of the field that holds the path to the configuration node containing service manager settings
...
**C#**<br />
``` C#
public const <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">string</a> ServiceManagerConfigurationPath = "ServiceManagerConfigurationPath"
```
