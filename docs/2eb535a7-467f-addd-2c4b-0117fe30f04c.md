# AzureSettings.ServiceManagerConfigurationPath Property 
...
**C#**<br />
``` C#
public <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">string</a> ServiceManagerConfigurationPath { get; set; }
```
